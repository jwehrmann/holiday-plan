# Iceland · 4-Base Wilderness Itinerary
**Sept 10 – 29, 2026 · 19 nights · 4 Airbnbs · 4x4 SUV · Sony a7RV**

Land KEF **Sept 10, 9:25 AM** (YVR red-eye) → depart **Sept 29**. Clockwise route: South Coast → Eastfjords → North → Snæfellsnes, ending 2.5 h from the airport.

**Changes from the draft (both cut dead driving):**
- **Base 2 = Egilsstaðir**, not Seyðisfjörður — it's the hub every East hike radiates from; Seyðisfjörður becomes a day trip (~+50 min/day saved).
- **Base 3 = Eyjafjörður valley / Akureyri**, not Siglufjörður — Kerling trailhead 30 min instead of 1 h 15, Aldeyjarfoss 1 h 15 instead of 2 h 30; Siglufjörður becomes a day trip.
- **Base 4 (recommended) = Snæfellsnes (Grundarfjörður)** instead of the Westfjords — full Westfjords alternative preserved below.
...
**Full route:** [Google Maps — KEF → Klaustur → Egilsstaðir → Akureyri → Grundarfjörður → KEF](https://www.google.com/maps/dir/Keflav%C3%ADk+International+Airport/Kirkjub%C3%A6jarklaustur/Egilssta%C3%B0ir/Akureyri/Grundarfj%C3%B6r%C3%B0ur/Keflav%C3%ADk+International+Airport)
...
- **Sept 17 (Wed):** **Stuðlagil east bank sunrise** → **Hengifoss** afternoon; aurora watch at the canyon rim.
- **Sept 18 (Thu):** **Brúnavík loop**; Álfaborg + Hafnarhólmi harbour on the way out.
...
| **Tröllaskagi loop + Siglufjörður** | 76 km · 1 h | strolls | — | Scenic day | full day | Any | — |
| **Mývatn: Hverir, Dimmuborgir** | ~100 km · 1 h 15 | short walks | — | Easy | flex | Evening baths | — |

**Day by day**
- **Sept 20 (Sat):** Transfer with Dettifoss → Ásbyrgi → Mývatn → Goðafoss sunset.
- **Sept 21 (Sun):** Recovery: Akureyri town, Bónus restock, **Forest Lagoon**; Goðafoss under stars if clear.
- **Sept 22 (Mon):** **Kerling summit** on the best visibility window (start 8:00, turnaround 14:00; winter kit up top).
- **Sept 23 (Tue):** **Aldeyjarfoss sunrise** (+ Hrafnabjargafoss) → Goðafoss → Mývatn or rest.
- **Sept 24 (Wed):** **Siglufjörður/Tröllaskagi loop** (Herring Era Museum, Hofsós pool) — or weather-flex.
- **Sept 25 (Thu):** Transfer west with Glymur.

**Transfer Sept 25 · Eyjafjörður → Grundarfjörður (~420 km, 5 h + hike):** leave 7:00 → optional **Hvítserkur** detour → **Glymur waterfall loop** ([7.2 km, ~430 m, hard, ~4 h](https://www.alltrails.com/trail/iceland/capital/glymur-waterfall-trail) — cave, log river-crossing, canyon rims; log removed early Oct, you're just in time) → **Bónus/N1 Borgarnes** (last big shop) → Grundarfjörður ~19:00. [Route](https://www.google.com/maps/dir/Akureyri/Glymur+Parking/Borgarnes/Grundarfj%C3%B6r%C3%B0ur)
...
| **Snæfellsjökull NP west loop** (Saxhóll, Svörtuloft, Djúpalónssandur, Lóndrangar) | 40–55 km | ~5 km total | ~100 m | Easy | half-day | Golden hour | — |
| **Búðakirkja black church** | ~55 km · 50 min | <1 km | — | Easy | evening | **Night sky** | — |
| **Glymur waterfall** | on transfer | 7.2 km loop | ~430 m | Hard | ~4 h | Midday | [link](https://www.alltrails.com/trail/iceland/capital/glymur-waterfall-trail) |

**Day by day**
- **Sept 25 (Thu):** Transfer + Glymur; arrive ~19:00.
- **Sept 26 (Fri):** **Kirkjufell sunrise on foot** → NP west loop → **Arnarstapi–Hellnar golden hour**. Full moon — moonlit Kirkjufell if clear.
- **Sept 27 (Sat):** **Helgrindur** on the calmest day (backup: guided Snæfellsjökull glacier summit) → Búðakirkja night shoot.
- **Sept 28 (Sun):** Flex: Rauðfeldsgjá, Ytri-Tunga seals, Eldborg crater; pack + refuel.
- **Sept 29 (Mon):** **Departure** — [Grundarfjörður → KEF ~2.5 h](https://www.google.com/maps/dir/Grundarfj%C3%B6r%C3%B0ur/Keflav%C3%ADk+International+Airport); leave 4–4.5 h before check-in closes. Farewell stop: Gerðuberg basalt columns.
...
|---|---|---|---|---|---|---|---|
| **Dynjandi** | ~60 km · 1 h | 1.6 km | 92 m | Short + steep | 40 min | Sunset (west-facing) | [AllTrails](https://www.alltrails.com/trail/iceland/westfjords/dynjandi-fjallfoss-trail) |
...
| **Bolafjall platform, Valagil, Ósvör** | 15–25 km | 2–5 km | varies | Easy–moderate | fill days | Any + aurora | — |

- **Sept 25:** Akureyri → Ísafjörður ~455 km, 5.5–6 h; Bónus Ísafjörður.
- **Sept 26:** Kaldbakur summit. **Sept 27:** Dynjandi sunset + Valagil. **Sept 28:** Bolafjall + flex, pack.
- **Sept 29:** Ísafjörður → KEF ~455 km / ~6 h — leave at dawn.

---

## Logistics

**Food.** Big-shop at Bónus/Krónan/Nettó at every base handover; rural stores are sparse and pricey. Day 1: Krónan Selfoss (5 days of food — Klaustur has only a small Kjarval). Sept 15: Nettó/Bónus Egilsstaðir. Sept 20/21: Bónus Akureyri. Sept 25: Bónus Borgarnes (or Ísafjörður). Trail food: skyr, flatkökur, dried fish, chocolate, instant soup — pack lunch daily, trailhead cafés don't exist.

**Fuel.** Never below half a tank — East/Westfjords station gaps exceed 100 km. Get an N1 fob / Orkan app (unmanned pumps, PIN required). Critical fill-ups: Selfoss, Vík, Klaustur, Höfn, Egilsstaðir, Reykjahlíð, Akureyri, Borgarnes. Budget ≈ 2,900 km ≈ 260 L ≈ **80,000 ISK (~$570)**.

**Water & kit.** Tap water is glacier-grade everywhere — two 1.5 L bottles each, refill daily; thermos on summit days. Clear mountain streams drinkable, milky glacial water not. Hard-shell top+bottom, insulation, hat/gloves (Kerling/Helgrindur can be winter up top), light microspikes, headlamps for pre-dawn starts. Download offline Google Maps + AllTrails/Wikiloc tracks.
...
- **Daylight:** Sept 10 (Klaustur) 6:22–19:59 (13.6 h) → Sept 29 (Grundarfjörður) 7:37–19:12 (11.6 h); you lose ~6 min/day. Long, lazy golden hours (~1.5 h).
...
| Sept 19 | 06:31 | 19:14 | 48% | First quarter |
...
| Sept 21 | 06:52 | 19:21 | 68% | Waxing gibbous |
| Sept 22 | 06:55 | 19:18 | 78% | Waxing gibbous — Kerling day: moon sets pre-dawn |
| Sept 23 | 06:58 | 19:14 | 86% | Waxing gibbous |
| Sept 24 | 07:01 | 19:10 | 92% | Waxing gibbous — moonlit Goðafoss works |

**Base 4 · Grundarfjörður — full-moon landscapes (Westfjords times within 1 min)**

| Date | Sunrise | Sunset | Moon | Phase |
|---|---|---|---|---|
| Sept 25 | 07:25 | 19:27 | 97% | Waxing gibbous |
| Sept 26 | 07:28 | 19:23 | 100% | **FULL MOON** — moonlit Kirkjufell night |
| Sept 27 | 07:31 | 19:19 | 100% | Full — Búðakirkja under moonlight |
| Sept 28 | 07:34 | 19:16 | 98% | Waning gibbous |
| Sept 29 | 07:37 | 19:12 | 94% | Waning gibbous — departure |
...
- **Aurora:** new moon **Sept 11**, full moon **Sept 26** → darkest skies in Bases 1–2. Check vedur.is aurora + cloud map at 21:00 nightly; chase cloud gaps, not Kp. Pre-scouted foregrounds: Jökulsárlón (B1), Stuðlagil/Seyðisfjörður (B2), Goðafoss/Mývatn (B3), Kirkjufell/Búðakirkja (B4). Baseline: 14–20 mm, f/1.8–2.8, 5–10 s, ISO 1600–6400.
